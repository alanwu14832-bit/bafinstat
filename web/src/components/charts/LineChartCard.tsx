...
export function LineChartCard({ data, series, formatValue, yDomain, yWidth = 40, height = 260, onPointClick, ...frame }: LineChartCardProps) {
  ...
  return (
    <ChartFrame height={height} legend={<ChartLegend series={resolved} />} {...frame}>
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 8, right: 12, bottom: 0, left: -4 }} {...chartClick(data, onPointClick)}>
